    ...
    <div className="shadow space-y-1 p-4 bg-white">
      ...
      <div className="flex justify-between gap-2 pb-4">
        <button
          ...
          className="bg-sky-700 p-2 text-white rounded-md font-bold shadow-md text-center"
        >
          <svg
        ...
        <button
          ...
          className="bg-red-700 p-2 text-white rounded-md font-bold shadow-md text-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
