        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex gap-2 items-center">
                    ...
                    @endguest
                    @auth
                        <a href="{{route('posts.create')}}" class="flex items-center gap-2 bg-white border p-2 text-gray-600 hover:bg-gray-50 transition-colors rounded text-sm uppercase font-bold cursor-pointer">
